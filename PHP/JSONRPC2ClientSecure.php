...
class Request 
{
    ...
    {
        $sScheme = (!isset($_SERVER['HTTPS']) || $_SERVER['HTTPS'] != 'on')
                        ? 'http' : 'https';
        ...
        if ($sScheme  == $oConfigApi->exception->scheme
            && $sHost == $oConfigApi->exception->host
            && $sPort == $oConfigApi->exception->port) {
